...
export const metadata: Metadata = {
  ...
  description: "Experience authentic Italian dining at Bella Vista. Traditional recipes, fresh ingredients, and exceptional service in an elegant atmosphere. Reserve your table today.",
  keywords: "Italian restaurant, authentic cuisine, fine dining, reservations, fresh ingredients, traditional recipes",
  openGraph: {
    title: "Bella Vista - Authentic Italian Restaurant",
    description: "Experience authentic Italian dining with traditional recipes and fresh ingredients",
